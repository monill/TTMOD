...
<div class="card">
    ...
    <?php
        $res = $db->select("SELECT `id`, `name`, `seeders`, `leechers` FROM `torrents` WHERE `seeders` = 0 AND `leechers` > 0 AND `banned` = 'no' AND `external` = 'no' ORDER BY `leechers` DESC LIMIT 5");
	?>
